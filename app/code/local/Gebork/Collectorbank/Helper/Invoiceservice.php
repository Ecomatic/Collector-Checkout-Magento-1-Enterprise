<?php
class Gebork_Collectorbank_Helper_Invoiceservice extends Gebork_Collectorbank_Helper_Data
{
    ...
    public function invoiceRowShipping($order) {
        return array(
            'ArticleId' => Gebork_Collectorbank_Model_Invoiceservice_Abstract::ART_ID_SHIPPING,
    ...
    public function invoiceRowFee($order) {
        ...
        return array(
            'ArticleId' => Gebork_Collectorbank_Model_Invoiceservice_Abstract::ART_ID_INVOICE_FEE,
    ...
    public function articleListFee($order) {
        $feeDescription = $order->getPayment()->getAdditionalInformation(
                Gebork_Collectorbank_Model_Collectorbank_Abstract::COLLECTOR_INVOICE_FEE_DESCRIPTION);
        return array(
            'ArticleId' => Gebork_Collectorbank_Model_Invoiceservice_Abstract::ART_ID_INVOICE_FEE,
