...
class Gebork_Collectorbank_Block_Creditmemo_Fee extends Mage_Adminhtml_Block_Sales_Order_Creditmemo_Totals
{   
    public function initTotals()
    {
        ...
        if ($cm) {
            ...
            if ($_invoice AND $_invoice->getId()) {
                ...
                $feeRefundedKey = Gebork_Collectorbank_Model_Collectorbank_Abstract::COLLECTOR_INVOICE_FEE_REFUNDED;
                $feeInvoiceNoKey = Gebork_Collectorbank_Model_Collectorbank_Abstract::COLLECTOR_INVOICE_FEE_INVOICE_NO;
