...
class Gebork_Collectorbank_Block_Form extends Mage_Payment_Block_Form
{
    ...
    protected function getLogoUrl() {
        return $this->getSkinUrl('images/gebork/collectorbank/logos/'.$this->getMethod()->getLogo());
    }
    ...
    public function getAgreementLink($type, $company = false) {
        ...
        // Disabled 2015-04-15, no longer in use, all private customers
        // should get _All_.
        /*if ($this->getMethodCode() == 'collector_account') {
            $agreementInvoiceType = self::AGREEMENT_TYPE_ACCOUNT . '_';
        }
        elseif($this->getMethodCode() == 'collector_partpayment' && $type != 'secci') {
            $agreementInvoiceType = 'All_';
        }*/
