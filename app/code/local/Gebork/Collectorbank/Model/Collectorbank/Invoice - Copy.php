...
class Gebork_Collectorbank_Model_Collectorbank_Invoice extends Gebork_Collectorbank_Model_Collectorbank_Abstract
{
    ...
    {
		echo "herere";die;
        // 2013-11-28, Added validation of shipping and billing address
        ...
        if ($originalIncrementId != null and $originalIncrementId != $newIncrementId) {
            ...
            $addInvoiceService = Mage::getModel('collectorbank/invoiceservice_addinvoice')
                ->setRequest($order, $this->getAdditionalData());

            $result = $addInvoiceService->addInvoice();
    ...
    {
        if (!$this->setRegCode(Mage::helper('collectorbank')->getModuleConfig('settings/serial'))->inRegister()) {
            return base64_decode('VW5saWNlbnNlZCB2ZXJzaW9uIG9mIENvbGxlY3Rvcg==');
        } else {
