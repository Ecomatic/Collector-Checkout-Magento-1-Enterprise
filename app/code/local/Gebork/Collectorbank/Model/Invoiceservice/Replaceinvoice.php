<?php
class Gebork_Collectorbank_Model_Invoiceservice_Replaceinvoice extends Gebork_Collectorbank_Model_Invoiceservice_Abstract
{
    protected $_request;
    ...
    public function setRequest(Mage_Sales_Model_Order $order, $additionalData = false) {
        ...
        $request = array(
            ...
            'InvoiceNo' => $payment->getAdditionalInformation(Gebork_Collectorbank_Model_Collectorbank_Abstract::COLLECTOR_INVOICE_NO),
        );
        ...
        $feeInvoiced = $payment->getAdditionalInformation(Gebork_Collectorbank_Model_Collectorbank_Abstract::COLLECTOR_INVOICE_FEE_INVOICED);
