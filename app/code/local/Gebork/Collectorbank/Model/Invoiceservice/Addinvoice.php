<?php
class Gebork_Collectorbank_Model_Invoiceservice_Addinvoice extends Gebork_Collectorbank_Model_Invoiceservice_Abstract
{
    protected $_request;
    ...
    public function setRequest(Mage_Sales_Model_Order $order, $additionalData = false) {
        ...
        $request = array(
            ...
            'ActivationOption' => $this->helper->getModuleConfig('settings/activation_option'),
