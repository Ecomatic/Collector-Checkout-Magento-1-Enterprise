<?php
class Gebork_Collectorbank_Model_Payment_Creditmemo_Total extends Mage_Sales_Model_Order_Creditmemo_Total_Abstract
{
    public function collect(Mage_Sales_Model_Order_Creditmemo $cm)
    {
        ...
        $feeInvoicedKey = Gebork_Collectorbank_Model_Collector_Abstract::COLLECTOR_INVOICE_FEE_INVOICED;
        $feeRefundedKey = Gebork_Collectorbank_Model_Collector_Abstract::COLLECTOR_INVOICE_FEE_REFUNDED;
        $feeInvoiceNoKey = Gebork_Collectorbank_Model_Collector_Abstract::COLLECTOR_INVOICE_FEE_INVOICE_NO;
